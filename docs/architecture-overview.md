...
│   │                                                                   │     │
│   │   Movement timer (variable: 6-12s wander, waypoint wait times)    │     │
│   │   ┌─────────────────────────────────────────────────────────┐     │     │
│   │   │  Movement Type 1 (Wander):                              │     │     │
│   │   │    - Pick random point within spawn_distance            │     │     │
│   │   │    - Calculate path via Pathfinding NIF                 │     │     │
│   │   │    - Send SMSG_MONSTER_MOVE to nearby players           │     │     │
│   │   │    - Schedule next wander (6-12s)                       │     │     │
│   │   │                                                         │     │     │
│   │   │  Movement Type 2 (Waypoint):                            │     │     │
│   │   │    - Follow preconfigured route                         │     │     │
│   │   │    - Wait at each point (from creature_movement)        │     │     │
│   │   │    - Loop back to start                                 │     │     │
│   │   └─────────────────────────────────────────────────────────┘     │     │
│   └───────────────────────────────────────────────────────────────────┘     │
│                                                                             │
