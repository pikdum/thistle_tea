defmodule ThistleTea.DB.Mangos.PickpocketingLootTemplate do
  @moduledoc false
  use Ecto.Schema
  ...
  schema "pickpocketing_loot_template" do
    field(:entry, :integer)
    field(:item, :integer)
  ...
  def query(entry) do
    from(flt in Mangos.PickpocketingLootTemplate, where: flt.entry == ^entry)
  end
end
