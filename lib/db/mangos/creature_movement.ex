defmodule ThistleTea.DB.Mangos.CreatureMovement do
  ...
  schema "creature_movement" do
    ...
    field(:textid1, :integer, virtual: true, default: 0)
    field(:textid2, :integer, virtual: true, default: 0)
    field(:textid3, :integer, virtual: true, default: 0)
    field(:textid4, :integer, virtual: true, default: 0)
    field(:textid5, :integer, virtual: true, default: 0)
    field(:emote, :integer, virtual: true, default: 0)
    field(:spell, :integer, virtual: true, default: 0)
    field(:orientation, :float, default: 0.0)
    field(:model1, :integer, virtual: true, default: 0)
    field(:model2, :integer, virtual: true, default: 0)
