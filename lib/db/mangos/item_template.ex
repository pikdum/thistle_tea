defmodule ThistleTea.DB.Mangos.ItemTemplate do
  ...
  schema "item_template" do
    ...
    field(:buy_count, :integer, default: 1)
    field(:buy_price, :integer, default: 0)
    field(:sell_price, :integer, default: 0)
    field(:inventory_type, :integer, default: 0)
    field(:allowable_class, :integer, default: -1)
    field(:allowable_race, :integer, default: -1)
    field(:item_level, :integer, default: 0)
    field(:required_level, :integer, default: 0)
    field(:required_skill, :integer, default: 0)
    field(:required_skill_rank, :integer, default: 0)
    field(:required_spell, :integer, default: 0)
    field(:required_honor_rank, :integer, default: 0)
    field(:required_city_rank, :integer, default: 0)
    field(:required_reputation_faction, :integer, default: 0)
    field(:required_reputation_rank, :integer, default: 0)
    field(:max_count, :integer, default: 0)
    field(:stackable, :integer, default: 1)
    field(:container_slots, :integer, default: 0)
    ...
    field(:ranged_mod_range, :float, default: 0.0, source: :range_mod)
    ...
    field(:page_text, :integer, default: 0)
    field(:language_id, :integer, default: 0, source: :page_language)
    field(:page_material, :integer, default: 0)
    field(:start_quest, :integer, default: 0)
    field(:lockid, :integer, default: 0, source: :lock_id)
    field(:material, :integer, default: 0)
    field(:sheath, :integer, default: 0)
    field(:random_property, :integer, default: 0)
    field(:block, :integer, default: 0)
    field(:item_set, :integer, default: 0, source: :set_id)
    field(:max_durability, :integer, default: 0)
    field(:area, :integer, default: 0, source: :area_bound)
    field(:map, :integer, default: 0, source: :map_bound)
    field(:bag_family, :integer, default: 0)
    field(:disenchant_id, :integer, default: 0)
    field(:food_type, :integer, default: 0)
    field(:min_money_loot, :integer, default: 0)
