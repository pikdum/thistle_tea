defmodule ThistleTeaWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    >
      ...
      <button type="button" class="group absolute top-1 right-1 p-2" aria-label="close">
        <span class="text-xl opacity-40 group-hover:opacity-70" aria-hidden="true">×</span>
      </button>
    </div>
    """
  end
  ...
  def flash_group(assigns) do
    ...
    <div id={@id}>
      ...
      >
        ...
        <span class="ml-1 inline-block motion-safe:animate-spin" aria-hidden="true">↻</span>
      </.flash>
  ...
  def error(assigns) do
    ~H"""
    <p class="mt-3 text-sm/6 text-rose-600">
      {render_slot(@inner_block)}
    </p>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ThistleTeaWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ThistleTeaWeb.Gettext, "errors", msg, opts)
    # end
