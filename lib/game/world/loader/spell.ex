defmodule ThistleTea.Game.World.Loader.Spell do
  ...
  defp effect_type(44), do: :skill_step
  ...
  defp effect_type(19), do: :add_extra_attacks
  ...
  defp effect_type(type) when type == 74 or type in 87..90, do: :summon_totem
  ...
  defp effect_type(123), do: :send_taxi
  ...
  defp effect_type(116), do: :remove_insignia
  ...
  defp aura_type(73), do: :mod_power_cost_school
  ...
  defp aura_type(131), do: :mod_ranged_attack_power_versus
  ...
  defp aura_type(158), do: :mod_shield_block_value
  defp aura_type(159), do: :honorless_target
  defp aura_type(160), do: :mod_aoe_avoidance
  ...
  defp target_type(30), do: :aoe_ally_at_source
  defp target_type(31), do: :aoe_ally_at_dest
  ...
  defp attributes(attrs, attrs_ex1, attrs_ex2, attrs_ex3, attrs_ex4) when is_integer(attrs) and is_integer(attrs_ex1) do
    ...
    |> add_if(attrs_ex3, 0x04000000, :can_proc_from_procs)
    ...
    |> add_if(attrs_ex1, 0x00000200, :initiates_combat)
