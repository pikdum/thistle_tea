defmodule ThistleTea.Game.Entity.Data.Component.Unit do
  ...
  use ThistleTea.Game.Entity.UpdateMask,
    ...
    base_attack_time: {0x007E, 1, :int},
    offhand_attack_time: {0x007F, 1, :int},
    ...
    min_offhand_damage: {0x0088, 1, :float, :special_info},
    max_offhand_damage: {0x0089, 1, :float, :special_info},
    bytes_1:
      {0x008A, 1,
       {:fn,
        [
    ...
    pet_experience: {0x008D, 1, :int, :private},
    pet_next_level_exp: {0x008E, 1, :int, :private},
    ...
    intellect: {0x0099, 1, :int, :private},
    spirit: {0x009A, 1, :int, :private},
    normal_resistance: {0x009B, 1, :int, :special_info},
    holy_resistance: {0x009C, 1, :int, :special_info},
    fire_resistance: {0x009D, 1, :int, :special_info},
    nature_resistance: {0x009E, 1, :int, :special_info},
    frost_resistance: {0x009F, 1, :int, :special_info},
    shadow_resistance: {0x00A0, 1, :int, :special_info},
    arcane_resistance: {0x00A1, 1, :int, :special_info},
    base_strength: :virtual,
    base_agility: :virtual,
    ...
    misc_flags: :virtual,
    pet_flags: :virtual,
    attack_power: {0x00A5, 1, :int, :private},
    attack_power_mods: {0x00A6, 1, :two_short, :private},
    attack_power_multiplier: {0x00A7, 1, :float, :private},
    ranged_attack_power: {0x00A8, 1, :int, :private},
    ranged_attack_power_mods: {0x00A9, 1, :two_short, :private},
    ranged_attack_power_multiplier: {0x00AA, 1, :float, :private},
    min_ranged_damage: {0x00AB, 1, :float, :private},
    max_ranged_damage: {0x00AC, 1, :float, :private},
    power_cost_modifier: {0x00AD, 7, :bytes, :private},
    power_cost_multiplier: {0x00B4, 7, :bytes, :private},
    auras: :virtual,
    equipment_bonuses: :virtual,
    base_attack_power: :virtual,
    attack_power_model: :virtual,
    base_ranged_attack_power: :virtual,
    ...
    base_offhand_attack_time: :virtual,
