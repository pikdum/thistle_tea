defmodule ThistleTea.Game.Entity.Data.Component.Unit do
  ...
  use ThistleTea.Game.Entity.UpdateMask,
    ...
    min_damage: {0x0086, 1, :float, :private},
    max_damage: {0x0087, 1, :float, :private},
    min_offhand_damage: {0x0088, 1, :float, :private},
    max_offhand_damage: {0x0089, 1, :float, :private},
    bytes_1:
      {0x008A, 1,
       {:fn,
        [
    ...
    normal_resistance: {0x009B, 1, :int, :private},
    holy_resistance: {0x009C, 1, :int, :private},
    fire_resistance: {0x009D, 1, :int, :private},
    nature_resistance: {0x009E, 1, :int, :private},
