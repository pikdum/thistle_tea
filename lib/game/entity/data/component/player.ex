defmodule ThistleTea.Game.Entity.Data.Component.Player do
  ...
  use ThistleTea.Game.Entity.UpdateMask,
    ...
    mod_damage_done_pos_physical: {0x04B1, 1, :int, :private},
    mod_damage_done_pos_holy: {0x04B2, 1, :int, :private},
    mod_damage_done_pos_fire: {0x04B3, 1, :int, :private},
    mod_damage_done_pos_nature: {0x04B4, 1, :int, :private},
    mod_damage_done_pos_frost: {0x04B5, 1, :int, :private},
    mod_damage_done_pos_shadow: {0x04B6, 1, :int, :private},
    mod_damage_done_pos_arcane: {0x04B7, 1, :int, :private},
