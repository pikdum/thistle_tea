defmodule ThistleTea.Game.Network.Message.CmsgForceSwimBackSpeedChangeAck do
  @moduledoc false
  use ThistleTea.Game.Network.ClientMessage, :CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK
