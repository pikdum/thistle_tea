defmodule ThistleTea.Game.Network.Message.SmsgItemQuerySingleResponse do
  @moduledoc false
  use ThistleTea.Game.Network.ServerMessage, :SMSG_ITEM_QUERY_SINGLE_RESPONSE
  ...
  @impl ServerMessage
  def to_binary(%__MODULE__{item_id: item_id, item: item}) do
