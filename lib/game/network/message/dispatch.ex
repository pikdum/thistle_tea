defmodule ThistleTea.Game.Network.Message.Dispatch do
  ...
  @messages %{
              ...
              CMSG_CHANNEL_LIST: Message.CmsgChannelList,
              CMSG_CHANNEL_PASSWORD: Message.CmsgChannelPassword,
              CMSG_CHANNEL_SET_OWNER: Message.CmsgChannelSetOwner,
              CMSG_CHANNEL_OWNER: Message.CmsgChannelOwner,
              CMSG_CHANNEL_MODERATOR: Message.CmsgChannelModerator,
              CMSG_CHANNEL_UNMODERATOR: Message.CmsgChannelUnmoderator,
              CMSG_CHANNEL_MUTE: Message.CmsgChannelMute,
              CMSG_CHANNEL_UNMUTE: Message.CmsgChannelUnmute,
              CMSG_CHANNEL_INVITE: Message.CmsgChannelInvite,
              CMSG_CHANNEL_KICK: Message.CmsgChannelKick,
              CMSG_CHANNEL_BAN: Message.CmsgChannelBan,
              CMSG_CHANNEL_UNBAN: Message.CmsgChannelUnban,
