defmodule ThistleTea.Game.Network.Message.CmsgMoveSplineDone do
  ...
  defstruct [:movement_block, :spline_id]
  ...
  def from_binary(payload) do
    movement_size = byte_size(payload) - 4
    <<movement_payload::binary-size(^movement_size), spline_id::little-size(32)>> = payload

    %__MODULE__{movement_block: MovementBlock.from_binary(movement_payload), spline_id: spline_id}
  end
end
