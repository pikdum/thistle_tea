defmodule ThistleTea.Game.Entity.Logic.AI.BT.BlackboardTest do
  ...
  describe "ready_for?/3" do
    ...
    test "is false when timestamp is in the future" do
      now = 1_000
      blackboard = %Blackboard{navigation: %Navigation{next_wander_at: now + 10_000}}
    ...
    test "is true when timestamp has passed" do
      now = 1_000
      blackboard = %Blackboard{navigation: %Navigation{next_wander_at: now - 1}}
  ...
  describe "new/0" do
    test "partitions memory into typed subsystem structs" do
      blackboard = Blackboard.new()

      assert %Blackboard{
               navigation: %Navigation{},
               combat: %Blackboard.Combat{},
               spells: %Blackboard.Spells{},
               event_ai: %Blackboard.EventAI{},
               maintenance: %Blackboard.Maintenance{}
             } = blackboard
    end
  end
end
